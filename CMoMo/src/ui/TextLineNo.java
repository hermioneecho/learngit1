...
public class TextLineNo extends JPanel implements CaretListener,DocumentListener, PropertyChangeListener { 
	 ...
	 */
	public TextLineNo(JTextComponent component) {
		this(component, 3);
	}
	 ...
	 *            the component
	 */
	public TextLineNo(JTextComponent component, int minimumDisplayDigits) {
